...
def generate_contract(application):
    ...
    context = {
        ...
        'LandlordAddress': landlord_info.address if landlord_info else None,
    ...
    c.setFont("DejaVuSans", 12)  # Use Unicode-compatible font
    ...
    # Property details
    c.setFont("DejaVuSans", 14)
    c.drawString(50, y, "Xəritə məlumatları")
    y -= 20
    c.setFont("DejaVuSans", 12)
    ...
    y -= 40
    c.setFont("DejaVuSans", 12)
    c.drawString(50, y, "İmzalar:")
    y -= 20
    c.setFont("DejaVuSans", 12)
    c.drawString(50, y, f"Kirayə: {application.landlord_signature}")
    y -= 20
    c.drawString(50, y, f"İstifadəçi: {application.tenant_signature}")
